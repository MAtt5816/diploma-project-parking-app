...
<html>
    ...
    <body>
        <br><br><section class="container">
                ...
                <input type="text" class="form_input" name="phone" placeholder="Numer telefonu" required="true" pattern="[0-9]{11}">
                <h4>Dane konta</h4><hr>
                ...
                <h4>Dane firmy</h4><hr>
                <input type="text" class="form_input" name="tin" placeholder="Nip" maxlength="11" required="true"></aside>

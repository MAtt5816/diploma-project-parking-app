...
<html>
    ...
    <body>
        <br><br><section class="container">
                ...
                <input type="text" class="form_input" name="phone" placeholder="Numer telefonu" required="true" pattern="[0-9]{9}"><br>
                <h4>Dane konta</h4><hr>
                ...
                <input type="text" class="form_input" name="postal_code" placeholder="Kod pocztowy" required="true">
